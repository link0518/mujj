...
| 加内部群和社区             |  ×      | 本人维护有一个tg群和一个论坛，直接捐赠打赏60元/10U起加群,可终身免费咨询inst+1kdd技术支持+给discuss提issue+更多不定期福利 |
| 项目买断                  |  ×      | 50000u = minlearnprogramming全套ci构建源码仓库+inst.sh域名+discuss构建源码+programming.forum域名及运营论坛, 全部协助转让 |
| ...                      | ...     | ... |
